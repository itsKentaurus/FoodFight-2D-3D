...
namespace Asg26262732
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Menu = Content.Load<Texture2D>("Images/MainMenu/Menu");
            _Credits = Content.Load<Texture2D>("Images/Credit/Credits");
            _GameOver = Content.Load<Texture2D>("Images/GameOver/GameOver");
            btnPlay = new Button(Content.Load<Texture2D>("Images/MainMenu/Button"), graphics.GraphicsDevice);
            _Exit = new Button(Content.Load<Texture2D>("Images/MainMenu/Exit"), graphics.GraphicsDevice);


            _Resume = new Button(Content.Load<Texture2D>("Images/PauseMenu/Resume"), graphics.GraphicsDevice);
            _Hotkeys = new Button(Content.Load<Texture2D>("Images/PauseMenu/Hotkeys"), graphics.GraphicsDevice);
            _Credit = new Button(Content.Load<Texture2D>("Images/PauseMenu/Credits"), graphics.GraphicsDevice);
            _BackToStart = new Button(Content.Load<Texture2D>("Images/GameOver/BackToStart"), graphics.GraphicsDevice);
            Texture2D[] t = new Texture2D[2];
            t[0] = Content.Load<Texture2D>("Images/PauseMenu/FullScreenOff");
            t[1] = Content.Load<Texture2D>("Images/PauseMenu/FullScreenOn");
...
//            graphics.IsFullScreen = _FullScreenToggle;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            switch (_CurrentGameState)
            {
                ...
                case GameState.MainMenu:
                    elapse = 0;
                    startTimer = (float)gameTime.TotalGameTime.TotalMilliseconds;
        ...
        private void FirstTimeSetup(int NumFood, int NumHoles)
        {
            ...
            Banana[1] = Content.Load<Texture2D>("Images/PileBanana/PileBanana1");
            Banana[2] = Content.Load<Texture2D>("Images/PileBanana/PileBanana2");
            Banana[3] = Content.Load<Texture2D>("Images/PileBanana/PileBanana3");
            Banana[4] = Content.Load<Texture2D>("Images/PileBanana/PileBanana4");
            Banana[5] = Content.Load<Texture2D>("Images/PileBanana/PileBanana5");
            Banana[6] = Content.Load<Texture2D>("Images/PileBanana/PileBanana6");
            /*  Set Ground Pizza Texture */
            Texture2D[] Pizza = new Texture2D[7];
            Pizza[0] = Content.Load<Texture2D>("Images/General/Pile");
            Pizza[1] = Content.Load<Texture2D>("Images/PilePizza/PilePizza1");
            Pizza[2] = Content.Load<Texture2D>("Images/PilePizza/PilePizza2");
            Pizza[3] = Content.Load<Texture2D>("Images/PilePizza/PilePizza3");
            Pizza[4] = Content.Load<Texture2D>("Images/PilePizza/PilePizza4");
            Pizza[5] = Content.Load<Texture2D>("Images/PilePizza/PilePizza5");
            Pizza[6] = Content.Load<Texture2D>("Images/PilePizza/PilePizza6");
            /*  Set Ground Orange Texture */
            Texture2D[] Orange = new Texture2D[7];
            Orange[0] = Content.Load<Texture2D>("Images/General/Pile");
            Orange[1] = Content.Load<Texture2D>("Images/PileOrange/PileOrange1");
            Orange[2] = Content.Load<Texture2D>("Images/PileOrange/PileOrange2");
            Orange[3] = Content.Load<Texture2D>("Images/PileOrange/PileOrange3");
            Orange[4] = Content.Load<Texture2D>("Images/PileOrange/PileOrange4");
            Orange[5] = Content.Load<Texture2D>("Images/PileOrange/PileOrange5");
            Orange[6] = Content.Load<Texture2D>("Images/PileOrange/PileOrange6");
            ...
            _SingleFOOD.Add(Content.Load<Texture2D>("Images/ThrownObject/Orange"));
            _SingleFOOD.Add(Content.Load<Texture2D>("Images/ThrownObject/Pizza"));
            _SingleFOOD.Add(Content.Load<Texture2D>("Images/ThrownObject/banana"));
            ...
            Texture2D IceCreamCone = Content.Load<Texture2D>("Images/IceCreamCone/IceCream");
